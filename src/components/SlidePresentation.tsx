  ...
  return (
    <div className={cn(
      ...
      <div className={cn(
        ...
        {title && (
          <h1 className={cn(
            "font-extrabold tracking-tighter text-foreground text-center animate-in fade-in slide-in-from-top-4 duration-700 break-words w-full leading-snug sm:leading-normal",
            isFullScreen 
